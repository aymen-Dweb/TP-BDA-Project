...
--	NOM & PRENOM.	    BENKOUITEN AYMEN   &   KENAI IMAD EDDINE
--      GROUPE.		    G3
--	SECTION.	    M1_SII_2023
--      MODULE.             BDA
...
--Calculer pour chaque client, le nombre de réservations effectuées :
        ...
        alter type Client_Type add member function resClient return numeric cascade;
...
--Calculer pour chaque hôtel, le nombre de chambres.
        ...
        alter type Hotel_Type add member function nbCham return numeric cascade;
...
--Calculer pour chaque chambre, son chiffre d’affaire.
        ...
        alter type Chambre_Type add MEMBER FUNCTION ChiffreAffaire RETURN numeric cascade;
...
----Methodes pour Calculer pour chaque hôtel, le nombre d’évaluations reçues à une date donnée (01-01-2022)

        alter type Hotel_Type add member function nbEval(p_dateEvaluation DATE) return numeric cascade;
...
--//changer la format date pour pouvez faire les insertions de reservation et evaluation qui contient des dates
...
--Reservation
        ...
        INSERT INTO reservation VALUES (Reservation_Type(6, 7, 30, '2022-05-01', '2022-04-27',(select ref(a) from Client a where NumClient=6 and rownum = 1),(select ref(a) from Chambre a where NumChambre=30 and rownum = 1),(select ref(a) from Hotel a where NumHotel=7 and rownum = 1)));
        INSERT INTO reservation VALUES (Reservation_Type(6, 10, 100, '2022-06-14', '2022-06-11',(select ref(a) from Client a where NumClient=6 and rownum = 1),(select ref(a) from Chambre a where NumChambre=100 and rownum = 1),(select ref(a) from Hotel a where NumHotel=10 and rownum = 1)));
        INSERT INTO reservation VALUES (Reservation_Type(13, 6, 2, '2022-05-10', '2022-05-02',(select ref(a) from Client a where NumClient=13 and rownum = 1),(select ref(a) from Chambre a where NumChambre=2 and rownum = 1),(select ref(a) from Hotel a where NumHotel=6 and rownum = 1)));
        INSERT INTO reservation VALUES (Reservation_Type(14, 6, 2, '2022-05-01', '2022-04-28',(select ref(a) from Client a where NumClient=14 and rownum = 1),(select ref(a) from Chambre a where NumChambre=2 and rownum = 1),(select ref(a) from Hotel a where NumHotel=6 and rownum = 1)));
        INSERT INTO reservation VALUES (Reservation_Type(14, 4, 21, '2022-05-13', '2022-05-12',(select ref(a) from Client a where NumClient=14 and rownum = 1),(select ref(a) from Chambre a where NumChambre=21 and rownum = 1),(select ref(a) from Hotel a where NumHotel=4 and rownum = 1)));
        INSERT INTO reservation VALUES (Reservation_Type(23, 6, 1, '2022-05-09', '2022-05-04',(select ref(a) from Client a where NumClient=23 and rownum = 1),(select ref(a) from Chambre a where NumChambre=1 and rownum = 1),(select ref(a) from Hotel a where NumHotel=6 and rownum = 1)));
        INSERT INTO reservation VALUES (Reservation_Type(28, 8, 100, '2022-05-03', '2022-04-30',(select ref(a) from Client a where NumClient=28 and rownum = 1),(select ref(a) from Chambre a where NumChambre=100 and rownum = 1),(select ref(a) from Hotel a where NumHotel=8 and rownum = 1)));
        INSERT INTO reservation VALUES (Reservation_Type(28, 9, 3, '2022-04-14', '2022-04-13',(select ref(a) from Client a where NumClient=28 and rownum = 1),(select ref(a) from Chambre a where NumChambre=3 and rownum = 1),(select ref(a) from Hotel a where NumHotel=9 and rownum = 1)));
        INSERT INTO reservation VALUES (Reservation_Type(16, 8, 301, '2022-05-03', '2022-05-01',(select ref(a) from Client a where NumClient=16 and rownum = 1),(select ref(a) from Chambre a where NumChambre=301 and rownum = 1),(select ref(a) from Hotel a where NumHotel=8 and rownum = 1)));
...
--Insertion dans HotelEvaluation  on utilise la table hotal  RMQ: on a pas des hotel avec une moy>=6 mais avec 5 si
...
--Quels sont les hôtels (nom, ville) ayant obtenu une moyenne de notes >=6, durant l’année 2022
        ...
        --comme ca on va trouver aucun hotel qui a obtenu une moyenne de notes >=6
        --on va juste essayer pour une moyenne de notes >=5 :
